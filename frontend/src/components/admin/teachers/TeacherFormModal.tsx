...
export function TeacherFormModal({ isOpen, onClose, onSuccess }: TeacherFormModalProps) {
    ...
    useEffect(() => {
        const loadClasses = async () => {
            ...
            try {
                ...
                console.error("[TeacherFormModal] Erro ao carregar turmas:", error)
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // O role "TEACHER" corresponde ao valor 2 no enum Roles
            await createUser(userData, "TEACHER", selectedImage)
            ...
            if (error instanceof z.ZodError) {
                ...
                console.error("[TeacherFormModal] Erro ao cadastrar professor:", error)
            ...
            <DialogContent className="w-[95vw] sm:w-full max-w-2xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto p-4 sm:p-6">
                <div className="relative">
                    <DialogHeader className="pb-6">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">Preencha os dados do professor para cadastro no sistema</p>
                            </div>
                        </div>
                    </DialogHeader>
                    ...
                    <div className="space-y-2">
                        ...
                        />
                        <p className="text-xs text-gray-500">Instituição padrão para novos professores</p>
                    </div>
