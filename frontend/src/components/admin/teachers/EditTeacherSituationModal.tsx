...
interface EditTeacherSituationModalProps {
    isOpen: boolean
    onClose: () => void
    onSuccess: () => void
    user: UserData | null
...
export function EditTeacherSituationModal({ isOpen, onClose, onSuccess, user }: EditTeacherSituationModalProps) {
                        ...
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">
                                    {user?.status === "ATIVO" 
                                        ? `Desativar ${user?.nome || "professor"}`
                                        : `Ativar ${user?.nome || "professor"}`
                                    }
                                </p>
                            </div>
                        </div>
