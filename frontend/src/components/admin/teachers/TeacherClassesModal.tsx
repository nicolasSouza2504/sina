...
export function TeacherClassesModal({ isOpen, onClose, teacher }: TeacherClassesModalProps) {
                    ...
                    <DialogHeader className="pb-6">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">{teacher?.nome}</p>
                            </div>
                        </div>
                    </DialogHeader>
                    ...
                    {classes.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-sm text-gray-500">
                                Este professor ainda não está vinculado a nenhuma turma.
                            </p>
                        </div>
                    ) : (
