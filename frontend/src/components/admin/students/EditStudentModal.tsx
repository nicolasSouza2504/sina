...
export function EditStudentModal({ isOpen, onClose, onSuccess, user }: EditUserModalProps) {
    ...
    useEffect(() => {
        if (user) {
            console.log('[EditStudentModal] Carregando dados do usuário:', {
                userId: user.id,
                userName: user.nome,
            ...
            console.log('[EditStudentModal] IDs das turmas do usuário:', userClassIds)
            console.log('[EditStudentModal] Classes brutas:', user.classes)
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.log('[EditStudentModal] Estado antes do envio:', {
                selectedClassIds,
            ...
            if (selectedClassIds.length > 0) {
                ...
                console.log('[EditStudentModal] Adicionando classesId:', selectedClassIds)
            } else {
                console.log('[EditStudentModal] Nenhuma turma selecionada, classesId não será enviado')
            }

            // Adiciona password apenas se updatePassword estiver marcado
            if (updatePassword && formData.password) {
                userData.password = formData.password
                console.log('[EditStudentModal] Adicionando password')
            }

            console.log('[EditStudentModal] Payload final:', userData)
    ...
    const resetForm = () => {
        setFormData({ name: "", email: "", cpf: "", roleId: 3, password: "" })
    ...
    const handleClassesConfirm = (classIds: number[]) => {
        console.log('[EditStudentModal] Recebendo turmas confirmadas:', classIds)
                ...
                <div className="relative">
                    ...
                    <div className="space-y-2">
                        ...
                        <Button
                            ...
                            variant="outline"
                            onClick={() => {
                                console.log('[EditStudentModal] Abrindo modal de turmas com selectedClassIds:', selectedClassIds)
                                console.log('[EditStudentModal] Turmas disponíveis:', availableClasses.length)
