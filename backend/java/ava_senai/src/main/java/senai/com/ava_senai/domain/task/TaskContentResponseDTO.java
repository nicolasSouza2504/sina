...
public record TaskContentResponseDTO(TaskContentType taskContentType, TaskContentUploadStatus uploadStatus) {

    public TaskContentResponseDTO(TaskContent taskContent) {
        this(taskContent.getContentType(), taskContent.getStatus());
    }
